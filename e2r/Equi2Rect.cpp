...
struct config {
    int width = 960;
    int height = 1080;
    int focal_length = 672;
    double pan_angle = 0.349066;
    double tilt_angle = 0.174533;
    double roll_angle = 0.0;
	std::string img_src_path = "images/pano.jpg";
	std::string img_dst_path = "images/pano_rect.jpg";
} cfg;
...
Equi2Rect::Equi2Rect()
{
    ...
    viewport.pan_angle = cfg.pan_angle;
    viewport.tilt_angle = cfg.tilt_angle;
    viewport.roll_angle = cfg.roll_angle;
    ...
    // read src image
    img_src = cv::imread(cfg.img_src_path, cv::IMREAD_COLOR);
    if (img_src.empty())
    {
